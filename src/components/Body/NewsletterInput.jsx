...
export default function NewsletterInput() {
  return (
    <main className="text-white flex flex-col flex-1 gap-y-4">
        ...
        <p className="text-xs text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur fuga doloribus hic consectetur ..</p>
        <div className="w-full bg-white p-1 rounded-md flex gap-1">
            ...
            <button className="bg-primary py-1 px-4 text-sm font-bold rounded-md">Subscribe</button>
        </div>
    </main>
  )
}
